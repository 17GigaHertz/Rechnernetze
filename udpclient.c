...
int main(int argc, char *argv[])
{
    ...
    ******************************************************************* */
	...
	sockfd = socket(their_addr.sin_family, SOCK_DGRAM, IPPROTO_UDP);
    ...
    ***********************************************pack******************** */
    ...
    //connect(sockfd, (struct sockaddr*)&their_addr, sizeof(their_addr)); //connect beim Datagram socket nicht vorgesehen 
...
//sendto erfolgt ohne vorheriges connect, enthält deshalb selbst die Adresse 
    /* ******************************************************************
